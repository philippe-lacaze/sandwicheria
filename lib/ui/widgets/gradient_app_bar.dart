...
class GradientAppBar extends StatefulWidget implements PreferredSizeWidget {
  GradientAppBar({
    ...
    this.gradiantOffsetStart = const FractionalOffset(0.0, 0.0),
    this.gradiantOffsetEnd = const FractionalOffset(0.0, 1.0),
    this.brightness,
    this.iconTheme,
    this.textTheme,
    this.primary = true,
  ...
  final  FractionalOffset gradiantOffsetStart;
  final  FractionalOffset gradiantOffsetEnd;
          ...
          child: Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                  ...
                  begin: widget.gradiantOffsetStart,
                  end: widget.gradiantOffsetEnd,
                  stops: [0.0, 1.0],
